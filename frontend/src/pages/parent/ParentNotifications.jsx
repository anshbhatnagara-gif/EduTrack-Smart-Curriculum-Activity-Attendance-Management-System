  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <PageHeader title="Parent Notifications" description="Child absence alerts, low attendance warnings, and exam result notices" />
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Receive real-time alerts regarding child absence, low attendance warnings, exam mark publications, and school announcements"
        actions={
          unreadCount > 0 && (
            <button
      ...
      <div className="space-y-3">
        {notifications.length > 0 ? (
          ...
          <div className="bg-white p-12 rounded-2xl border border-slate-200 text-center space-y-2">
            ...
            <p className="text-xs text-slate-400">No new alerts for your guardian account.</p>
          </div>
        )}
      </div>
    </div>
